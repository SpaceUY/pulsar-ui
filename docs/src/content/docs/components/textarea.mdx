...
<Playground src="https://pulsarui-playground.netlify.app/ui-kit/textarea?showHeader=false" />

## Import

```typescript
import { TextArea, type InputRef } from '@space-uy/pulsar-ui';
```
...
| `containerVariant` | `'default' \| 'alternative'` | ❌   | `'default'`   | Visual variant for the textarea container          |
