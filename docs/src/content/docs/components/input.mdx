...
<Playground src="https://pulsarui-playground.netlify.app/ui-kit/inputs?showHeader=false" />

## Import

```typescript
import { Input, type InputRef } from '@space-uy/pulsar-ui';
```
...
| `containerVariant` | `'default' \| 'alternative'`     | ❌       | `'default'`     | Visual variant for the input container background |
