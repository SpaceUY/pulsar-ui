...
| ------------------ | ---------------------------- | -------- | ------------- | -------------------------------------------------- |
| `length`           | `number`                     | ❌       | `4`           | Number of OTP cells to render                      |
| `value`            | `string`                     | ❌       | `''`          | Current OTP code value                             |
| `onChange`         | `(code: string) => void`     | ❌       | -             | Called whenever the OTP code changes               |
| `secure`           | `boolean`                    | ❌       | `false`       | When `true`, masks digits like a password input    |
| `variant`          | `'default' \| 'alternative'` | ❌       | `'default'`   | Visual variant for the underlying input container  |
